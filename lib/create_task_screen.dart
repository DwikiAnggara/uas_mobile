...
import 'package:uas_mobile/app_color.dart';
import 'package:uas_mobile/widget_background.dart';
  ...
  Widget _buildWidgetButtonCreateTask() {
    return Container(
      ...
      child: RaisedButton(
        ...
        child: Text(widget.isEdit ? 'Update Product' : 'Create Product'),
        ...
        onPressed: () async {
          ...
          if (name.isEmpty) {
            _showSnackBarMessage('Employee Name is required');
            return;
          } else if (description.isEmpty) {
            _showSnackBarMessage('Product Name is required');
            return;
          }
